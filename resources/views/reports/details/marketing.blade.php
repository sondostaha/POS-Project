                            ...
                            <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                <thead>
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title"> العميل الاساسي</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title"> نسبة التسويق</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">قيمة التسويق بالعمولة</span>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <div class="d-flex">
                                                    ...
                                                    @if ($order->clientAtrrs != null)
                                                        <a href="#" class="text-dark fw-500">
                                                           <h6>{{$order->cleintsAtrrs->name}}</h6>
                                                        </a>
                                            ...
                                            <td>
                                                ...
                                                <h6>{{number_format($order->cvalue * ($marketing->level1/100),2)}}</h6>
                                                </div>
                                            </td>
