                        ...
                        <div class="table-responsive">
                          <div class="adv-table-table__header">
                            ...
                            <div class="adv-table-table__button">
                                <a href="{{route('add_transfer' , app()->getLocale())}}"  class="btn btn-primary fs-6 fw-bold text-center" >
                                ...
                                <table class="table text-md-nowrap mt-2" id="example1">
                                  <thead>
                                    <tr>
                                      ...
                                      <th class="wd-10p border-bottom-0 " >وكيل المبيعات</th>
                                  ...
                                  <tbody>
                                    ...
                                    <td>
                                        <ul class="orderDatatable_actions mb-0 d-flex ">
                                            ...
                                            <li>
                                                <a href="{{route('edit_transfer' , [app()->getLocale() , $transfer->id])}}" class="edit">
                                                    <i class="uil uil-edit"></i></a>
                                            </li>
                                            <li>
                                                <a href="{{route('delete_transfer' , [app()->getLocale() , $transfer->id])}}" class="remove">
