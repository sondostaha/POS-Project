                            ...
                            <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                <thead>
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title">حاله المستقل</span>
                                        </th>
                                        <th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul class="orderDatatable_actions mb-0 d-flex ">
                                                @if($request_freelancer->freelancer_status != 'يوجد')
                                                <li>
                                                    <a href="{{route('freelance_status' , [app()->getLocale() , $request_freelancer->id])}}" title="تغيير حاله المستقل">
