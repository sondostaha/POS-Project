    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="breadcrumb-main">
                <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.add_main_field') }}</h4>
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="las la-home"></i>مجالات العمل</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('menu.add_main_field') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-lg-12">
            <div class="card card-Vertical card-default card-md mb-4">
                <div class="card-header">
                    <h6>{{ trans('menu.add_main_field') }}</h6>
                </div>
