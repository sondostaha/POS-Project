                    ...
                    <div class="userDatatable adv-table-table global-shadow border-0 bg-white w-100 adv-table">
                        <div class="table-responsive">
                          <div class="adv-table-table__header">
                            <h4>{{ trans('menu.financial_report_to_the_human_resources_res') }}</h4>
                                ...
                                <table class="table text-md-nowrap mt-2" id="example1">
                                  <thead>
                                    <tr>
                                      ...
                                      <th class="wd-15p border-bottom-0 " >مستحقات المسؤول</th>
                                  ...
                                  <tbody>
                                    <tr>
                                        ...
                                        <td>
                                          <form action="{{route('store_proof_res' , app()->getLocale())}}" method="post">
                                            @csrf
