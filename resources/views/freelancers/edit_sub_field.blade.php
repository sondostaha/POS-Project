    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="breadcrumb-main">
                <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.edit_sub_field') }}</h4>
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="las la-home"></i>مجالات العمل</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('menu.edit_sub_field') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-lg-12">
            <div class="card card-Vertical card-default card-md mb-4">
                <div class="card-header">
                    <h6>{{ trans('menu.edit_sub_field') }}</h6>
                </div>
                <div class="card-body py-md-30">

                    @include('partials._errors')

            <form action="{{route('update_sub_field',[app()->getLocale() , $field->id])}}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 mb-25">
                        ...
                        <div class="form-group select-px-15 text-end">
                            ...
                            <select class="form-control px-15 text-end" id="mainField" name="main_field_id" required>
                                ...
                                <option value="{{$main->id}}" {{$main->title == $field->mainField->title ? 'selected' : ''}}>{{$main->title}}</option>
