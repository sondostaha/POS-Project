                            ...
                            <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                <thead>
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title">  وكيل المبيعات</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title"> نسبة وكيل المبيعات </span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">مرتب وكيل المبيعات</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">عموله وكيل المبيعات</span>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="userDatatable-inline-title">
                                                        <a href="#" class="text-dark fw-500">
                                                        <h6>{{$sales_team->sales_agent_salary}}</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <h6>{{number_format(($order->finalValue * ($sales_team->sales_agent/100)) + $sales_team->sales_agent_salary,2)}}</h6>
                                                </div>
                                            </td>
