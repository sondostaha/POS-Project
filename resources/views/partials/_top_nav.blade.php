                ...
                <div class="dropdown-custom">
                    @switch(app()->getLocale())
                        @case('en')
                            ...
                            @break
                        @case('ar')
                            <a href="javascript:;" class="nav-item-toggle"><img src="{{ asset('assets/img/egypt.png') }}" alt="" class="rounded-circle"></a>
                            @break
                        @default
                            <a href="javascript:;" class="nav-item-toggle"><img src="{{ asset('assets/img/egypt.png') }}" alt="" class="rounded-circle"></a>
                            @break
                    ...
                    @if(isset($freelancer))
                            <div class="dropdown-wrapper dropdown-wrapper--small">
                                <a href="{{ route(Route::currentRouteName(),['en',$freelancer->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                                <a href="{{ route(Route::currentRouteName(),['ar',$freelancer->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                            </div>
                    ...
                    <div class="dropdown-wrapper dropdown-wrapper--small">
                        <a href="{{ route(Route::currentRouteName(),['en',$field->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                        <a href="{{ route(Route::currentRouteName(),['ar',$field->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                    </div>

                    @elseif(isset($request_freelancer))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$request_freelancer->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$request_freelancer->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>

                    @elseif(isset($plan))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$plan->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$plan->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>

                    @elseif(isset($franchise))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$franchise->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$franchise->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>

                    @elseif(isset($permission))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$permission->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$permission->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>

                    @elseif(isset($order))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$order->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$order->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>
                    @elseif(isset($transfer))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$transfer->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$transfer->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>

                    @elseif(isset($assign))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$assign->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$assign->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>
                    @elseif(isset($tree))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$tree->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$tree->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>
                    @elseif(isset($setting))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$setting->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$setting->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>

                    @elseif(isset($role))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$role->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$role->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>

                    @elseif(isset($operating))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$operating->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$operating->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>

                    @elseif(isset($client))

                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="{{ route(Route::currentRouteName(),['en',$client->id]) }}"><img src="{{ asset('assets/img/eng.png') }}" alt=""> English</a>
                            <a href="{{ route(Route::currentRouteName(),['ar',$client->id]) }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                        </div>
                    ...
                    <div class="dropdown-wrapper dropdown-wrapper--small">
                        ...
                        <a href="{{ route(Route::currentRouteName(),'ar') }}"><img src="{{ asset('assets/img/egypt.png') }}" alt=""> Arabic</a>
                    </div>
